...
// Function to get the last modified time of a Google Sheet
...
// Function to fetch the columns from a specific tab
async function fetchSheetColumns(
  ...
  const response = await sheets.spreadsheets.values.get({
    ...
    range: `${tabName}!1:1`, // Fetching the first row (header) which contains column names
  })
